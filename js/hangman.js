$(function () {
    ...
    function displayHangman() {
        ...
        {
            case 1:
                $('#hangmanImage').html("<img class='image' alt='hangman' src='../img/hangman2.png'>");
                break;
            case 2:
                $('#hangmanImage').html("<img class='image' alt='hangman' src='../img/hangman3.png'>");
                break;
            case 3:
                $('#hangmanImage').html("<img class='image' alt='hangman' src='../img/hangman4.png'>");
                break;
            case 4:
                $('#hangmanImage').html("<img class='image' alt='hangman' src='../img/hangman5.png'>");
                break;
            case 5:
                $('#hangmanImage').html("<img class='image' alt='hangman' src='../img/hangman6.png'>");
                break;
            case 6:
                $('#hangmanImage').html("<img class='image' alt='hangman' src='../img/hangman7.png'>");
                break;
            default:
                 $('#hangmanImage').html('<img class="image" alt="hangman" src="../img/hangman1.png">');
        }
    }
